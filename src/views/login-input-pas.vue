<template>
  <div class="row pas-row">
    <div class="input-container" :style="outerStyle">
      <input class="input" name="pas" :type="inputType" maxlength="16" ref="pas"
             :style="inputStyle"
      ...
      <label class="lab" :style="labStyle" @click="inHandle">密码</label>
    </div>
  ...
  export default {
    ...
    watch:{
      accValue:function (val) {
        ...
        this.$store.commit('changePas',this.accValue)
        if(val === ''){
